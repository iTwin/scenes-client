...
export interface ScenesApiSchemas {
  ...
  Layer: {
    /**
     * Layers act as organizational containers for scene content. They are not limited to contain specific data types.
     * Additional layer specific properties may be introduced in the future.
     */
    "1.0.0": Record<string, never>; // Record<string, never> for TS to enforce an empty object
  };
  MaterialDecoration: {
  ...
  RepositoryResource: {
    ...
    "1.0.0": {
      ...
      subClass?: SafeString;
      /** Version of the resource, if the repository supports versioning, e.g. an iModel changeset id. If omitted, the latest resource version is used. Format depends on the repository (may be a GUID or another string identifier). */
      version?: SafeString;
    };
  };
  View3d: {
